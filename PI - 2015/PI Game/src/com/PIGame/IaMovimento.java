...
// Reference: https://code.google.com/p/astar0/source/browse/trunk/AStar0/src/Quadrado.java?r=4
public class IaMovimento implements core {
		    ...
		    public void AStar(Quadrado grade[][], Quadrado origem, Quadrado destino) {
		        this.grade = grade;
		        this.origem = origem;
